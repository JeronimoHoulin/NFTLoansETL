...
class NFTFiV2OldParser(BaseParser):
    def __init__(self, abi_file=None):
        self.address = "0xf896527c49b44aAb3Cf22aE356Fa3AF8E331F280"
        if abi_file:
            self.abi_file = abi_file
        else:
            self.abi_file = "../abis/nftfi_v2_old.json"
        self.contract_name = "nftfi_v2_old"
        super().__init__()
    ...
    def extract(self, from_block, to_block):
        ...
        for loan in self.historical_active_nftfi_v2_old_loans:
