...
class NFTFiV2Parser(BaseParser):
    def __init__(self, abi_file=None):
        self.address = "0x8252Df1d8b29057d1Afe3062bf5a64D503152BC8"
        if abi_file:
            self.abi_file = abi_file
        else:
            self.abi_file = "../abis/nftfi_v2.json"
        self.contract_name = "nftfi_v2"
        super().__init__()
    ...
    def extract(self, from_block, to_block):
        ...
        for loan in self.historical_active_nftfi_v2_loans:
